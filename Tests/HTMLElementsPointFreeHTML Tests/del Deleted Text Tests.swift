    ...
    struct DelTests {
        ...
        func delWithDatetimeRendersCorrectly() {
            assertInlineSnapshot(
                ...
                """
                <del datetime="2024-03-10T14:30:00Z">Outdated policy information</del>
                """
            }
        }
        ...
        func delWithCiteRendersCorrectly() {
            assertInlineSnapshot(
                ...
                """
                <del cite="https://example.com/edit-log/456">Incorrect pricing information</del>
                """
            }
        }
        ...
        func delWithBothCiteAndDatetimeRendersCorrectly() {
            assertInlineSnapshot(
                ...
                """
                <del datetime="2024-02-05T10:15:00Z" cite="https://example.com/changelog/v1.9">Deprecated feature: Legacy authentication</del>
                """
            }
        }
        ...
        func delWithComplexContentRendersCorrectly() {
            assertInlineSnapshot(
                ...
                """
                <del datetime="2024-01-20T09:45:00Z"><strong>Notice:</strong> The old API endpoint <code>/api/v1/users</code> is no longer supported.</del>
                """
            }
        }
        ...
        func delInDocumentRevisionContextRendersCorrectly() {
            assertInlineSnapshot(
                ...
                <p>The conference will be held <del datetime="2024-02-28T16:00:00Z" cite="https://example.com/event-updates/789">in New York</del> virtually via Zoom.
                </p>
                """
            }
        }
            ...
            assertInlineSnapshot(
                ...
                <article>
                  ...
                  <section>
                    ...
                    <ul>
                      <li><del datetime="2024-01-10T12:00:00Z" cite="https://example.com/removals/feature-x">Experimental feature X (beta)</del>
                      </li>
                      <li><del datetime="2024-01-15T14:30:00Z" cite="https://example.com/removals/deprecated-api">Legacy API endpoints for user management</del>
                      </li>
                      <li><del datetime="2024-01-20T11:15:00Z">Outdated documentation sections</del>
                      </li>
                    </ul>
                  </section>
                  <p>For more information about these changes, see <del datetime="2024-02-01T10:00:00Z" cite="https://example.com/old-migration-guide"><a href="https://example.com/old-guide">the old migration guide</a></del> our updated documentation.
                  </p>
                </article>
                  </body>
                </html>
